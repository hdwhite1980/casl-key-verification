    ...
    try {
      ...
      if (langCode === 'en') {
        this.translations.en = {
          ...
          'auth.passwordRequirements': 'Password must be at least 8 characters and include a number',
          ...
          'auth.welcome': 'Welcome to CASL Key Verification',
          'auth.welcomeDescription': 'Verify your identity to get your CASL Key',
          'auth.firstTime': 'First time user',
        ...
        this.translations.es = {
          ...
          'auth.passwordRequirements': 'La contraseña debe tener al menos 8 caracteres e incluir un número',
          'auth.register': 'Registrarse',
          'auth.registering': 'Registrando...',
          'auth.haveAccount': '¿Ya tienes una cuenta?',
          'auth.passwordsDoNotMatch': 'Las contraseñas no coinciden',
          'auth.genericError': 'Autenticación fallida. Por favor, inténtalo de nuevo.',
          'auth.loggedInAs': 'Conectado como {username}',
          'auth.logout': 'Cerrar Sesión',
          'auth.logoutError': 'Error al cerrar sesión',
          'auth.welcome': 'Bienvenido a Verificación CASL Key',
          'auth.welcomeDescription': 'Verifica tu identidad para obtener tu CASL Key',
          'auth.firstTime': 'Usuario por primera vez',
          'auth.returningUser': 'Usuario que regresa',
